...
class TBranchMethods(object):
    ...
    #ddavila: Remove interpretation so that we can retrieve any kind of data
    def _my_basket(self, i, interpretation, local_entrystart, local_entrystop, awkward, basketcache, keycache):
        key = self._threadsafe_key(i, keycache, True)
        basketdata = key.basketdata()
        return basketdata

    #ddavila: Remove interpretation so that we can retrieve any kind of data
    def my_basket(self, i, interpretation=None, entrystart=None, entrystop=None, flatten=False, awkwardlib=None, cache=None, basketcache=None, keycache=None):
        entrystart, entrystop = _normalize_entrystartstop(self.numentries, entrystart, entrystop)
        ...
        source = self._my_basket(i, interpretation, local_entrystart, local_entrystop, awkward, basketcache, keycache)
        return source
